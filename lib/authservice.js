...
authService.sessionDeleted = (data, callback) => {
...
authService.createSession = (data, callback) => {
  // Reject any request that isn't a GET
  if(data.method == 'get'){
    // Prepare data for interpolation
    var templateData = {
      'head.title' : 'Sing In',
      'head.description' : 'Login to your account using email address and password',
